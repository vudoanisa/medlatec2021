(function () {
    ...
    AbstractChosen = (function () {
        ...
        AbstractChosen.default_create_option_text = "Thêm mới: ";
    ...
    Chosen = (function (_super) {
        ...
        Chosen.prototype.select_append_option = function (options) {
            var option;
            var value_op;
            var hahah = this.form_field_jq;
            var module = $('#ModuleCode').val();
            $.ajax({
                type: 'post',
                url: '/Dashboard/Api/AddTags/',
                data: {
                    Name: options.value,
                    Dyanamic: module.replace("Mod", ""),
                ...
                success: function (data) {
                    ...
                    if (value_op != null || value_op != undefined) {
                        options.value = value_op;
                        option = $('<option />', options).attr('selected', 'selected');
                        hahah.append(option);
                        hahah.trigger("chosen:updated");
                        hahah.trigger("change");
                    }
                },
